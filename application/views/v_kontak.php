	...
	<header id="fh5co-header" role="banner">
		<div class="container">
			<div class="header-inner">
				<h1><a href="<?php echo base_url().''?>">LENSA SOCA</a></h1>
				<nav role="navigation">
					<ul>
			...
			<div class="row">
				<div class="col-md-3">
					...
					<ul class="contact-info">
						<li><i class="icon-map"></i>Wauran Sukabumi</li>
						<li><i class="icon-phone"></i>0266 111987</li>
						<li><i class="icon-envelope"></i><a href="#"> cs@lensasoca.com</a></li>
						<li><i class="icon-globe"></i><a href="#">www.lensasoca.com</a></li>
					</ul>
				</div>
